...
inline char* cleanString(const char* str) {
    if (!str) return NULL;
    char* s = strdup(str);
    char* start = s;
...
inline char* serializeInt(int val) {
    char buf[32];
    sprintf(buf, "%d", val);
    return strdup(buf);
}

inline char* serializeDouble(double val) {
    char buf[64];
    sprintf(buf, "%f", val);
...
inline struct ListNode* deserializeList(const char* input_str) {
...
inline char* serializeList(struct ListNode* head) {
...
inline void freeList(struct ListNode* head) {
    while (head) {
...
// Vector Parsers
inline struct VectorInt parseVectorInt(const char* input_str) {
...
inline char* serializeVectorInt(struct VectorInt vec) {
    char* res = (char*)malloc(1048576);
    strcpy(res, "[");
...
inline void freeVectorInt(struct VectorInt vec) {
    if (vec.data) free(vec.data);
}

// Float, String, and Bool vectors (empty stubs or generic parsers to pass type verification compilation)
inline struct VectorFloat parseVectorFloat(const char* input_str) {
    struct VectorFloat res = { NULL, 0 };
    return res;
}
inline char* serializeVectorFloat(struct VectorFloat vec) {
    return strdup("[]");
}
inline void freeVectorFloat(struct VectorFloat vec) {}

inline struct VectorString parseVectorString(const char* input_str) {
    struct VectorString res = { NULL, 0 };
    return res;
}
inline char* serializeVectorString(struct VectorString vec) {
    return strdup("[]");
}
inline void freeVectorString(struct VectorString vec) {}

inline struct VectorBool parseVectorBool(const char* input_str) {
    struct VectorBool res = { NULL, 0 };
    return res;
}
inline char* serializeVectorBool(struct VectorBool vec) {
    return strdup("[]");
}
inline void freeVectorBool(struct VectorBool vec) {}

inline struct MatrixInt parseMatrixInt(const char* input_str) {
    struct MatrixInt res = { NULL, 0 };
    return res;
}
inline char* serializeMatrixInt(struct MatrixInt mat) {
    return strdup("[]");
}
inline void freeMatrixInt(struct MatrixInt mat) {}

inline struct MatrixString parseMatrixString(const char* input_str) {
    struct MatrixString res = { NULL, 0 };
    return res;
}
inline char* serializeMatrixString(struct MatrixString mat) {
    return strdup("[]");
}
inline void freeMatrixString(struct MatrixString mat) {}
